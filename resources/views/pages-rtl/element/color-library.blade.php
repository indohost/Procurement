<x-rtl.base-layout :scrollspy="true">
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col layout-spacing">
            <div class="color-box">
                <span class="cl-example" style="background-color: #42badb;"></span>
                <div class="cl-info">
        ...
        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col layout-spacing">
            <div class="color-box">
                <span class="cl-example" style="background-color: #227B94;"></span>
                <div class="cl-info">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col layout-spacing">
            <div class="color-box">
                <span class="cl-example" style="background-color: #139fb1;"></span>
                <div class="cl-info">
                    <h5 class="cl-title">#139fb1</h5>
                </div>
            </div>
        </div>
